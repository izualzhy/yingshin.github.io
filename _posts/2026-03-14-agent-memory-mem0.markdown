---
title: "基于Mem0的几款记忆框架&平台的调研"
date: 2026-03-14 09:36:32
tags: AI
cover: /assets/images/mem0/add_architecture.avif
---
...
火山云上同样有一款基于 Mem0 的记忆产品<sup>5</sup>，是在去年12月推出的。我感觉主要区别是有**记忆提取策略**的概念，系统内置了 3 种，同时也**支持用户自定义提取策略**：  
